...
export default function Projects() {
    return (
        <Container>
            ...
            <Card title="LaraBlog" description="A blog website using Laravel, PHP, MySQL and for styling using Bootstrap. Equipped with features such as authentication, CRUD." />
